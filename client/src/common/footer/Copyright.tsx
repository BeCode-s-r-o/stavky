...
const Copyright = ({ pageType }: PageType) => {
  ...
  const mail = pageType === 'forex' ? 'info@forexporadenstvo.sk' : 'info@stavkoveporadenstvo.sk';
  return (
      ...
      <div className="container">
        <div className="row align-items-center">
          ...
          <p style={{ fontSize: '1.1rem', textAlign: 'justify', marginTop: '20px', padding: '0 20px' }}>
            ...
            následne najneskôr do 24 hodín musí ukončiť predplatné a tým zamedziť ďalšiemu obnoveniu členstva. Kontakt:{' '}
            {mail}
          </p>
        </div>
      </div>
